    ...
    private P1GUI() {
        ...
        evaluateBtn.addActionListener((ActionEvent e) -> {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "An Infix Expression is required.","Error",JOptionPane.ERROR_MESSAGE);
                ...
                JOptionPane.showMessageDialog(null, "Invalid Character/s Used. Only 0-9 and +,-,*,/,(,) characters allowed.","Error",JOptionPane.ERROR_MESSAGE);
            } catch (EmptyStackException empty) {
                JOptionPane.showMessageDialog(null, "Invalid Infix Expression. Check Parentheses, Operators, and Operands.","Error",JOptionPane.ERROR_MESSAGE);
            }
        });
    }
